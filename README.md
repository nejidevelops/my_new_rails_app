...
**[Hello React Rails App]** is an application that allows to see messages and greetngs.
...
Clone this repository to your desired folder:
  ```sh
    git@github.com:mohammadnewton/my_new_rails_app.git
  ```
...
Feel free to check the [issues page](https://github.com/mohammadnewton/my_new_rails_app/issues).
